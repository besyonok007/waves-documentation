...
- **Заморозка**. [Транзакции](/blockchain/transaction.md) со смарт-ассетом могут быть запрещены до (или после) момента, когда [блокчейн](/blockchain/blockchain.md) наберёт определенную высоту.
